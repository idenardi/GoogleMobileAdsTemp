...
static class CFunctions
{
	...
	static extern GADAdSize GADPortraitInlineAdaptiveBannerAdSizeWithWidth (nfloat width);

	// extern GADAdSize GADLandscapeInlineAdaptiveBannerAdSizeWithWidth (CGFloat width);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADLandscapeInlineAdaptiveBannerAdSizeWithWidth (nfloat width);

	// extern GADAdSize GADCurrentOrientationInlineAdaptiveBannerAdSizeWithWidth (CGFloat width);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADCurrentOrientationInlineAdaptiveBannerAdSizeWithWidth (nfloat width);

	// extern GADAdSize GADInlineAdaptiveBannerAdSizeWithWidthAndMaxHeight (CGFloat width, CGFloat maxHeight);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADInlineAdaptiveBannerAdSizeWithWidthAndMaxHeight (nfloat width, nfloat maxHeight);

	// extern GADAdSize GADPortraitAnchoredAdaptiveBannerAdSizeWithWidth (CGFloat width);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADPortraitAnchoredAdaptiveBannerAdSizeWithWidth (nfloat width);

	// extern GADAdSize GADLandscapeAnchoredAdaptiveBannerAdSizeWithWidth (CGFloat width);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADLandscapeAnchoredAdaptiveBannerAdSizeWithWidth (nfloat width);

	// extern GADAdSize GADCurrentOrientationAnchoredAdaptiveBannerAdSizeWithWidth (CGFloat width);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADCurrentOrientationAnchoredAdaptiveBannerAdSizeWithWidth (nfloat width);

	// extern GADAdSize GADAdSizeFromCGSize (CGSize size);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADAdSizeFromCGSize (CGSize size);

	// extern GADAdSize GADAdSizeFullWidthPortraitWithHeight (CGFloat height);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADAdSizeFullWidthPortraitWithHeight (nfloat height);

	// extern GADAdSize GADAdSizeFullWidthLandscapeWithHeight (CGFloat height);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADAdSizeFullWidthLandscapeWithHeight (nfloat height);

	// extern BOOL GADAdSizeEqualToSize (GADAdSize size1, GADAdSize size2);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern bool GADAdSizeEqualToSize (GADAdSize size1, GADAdSize size2);

	// extern CGSize CGSizeFromGADAdSize (GADAdSize size);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern CGSize CGSizeFromGADAdSize (GADAdSize size);

	// extern BOOL IsGADAdSizeValid (GADAdSize size);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern bool IsGADAdSizeValid (GADAdSize size);

	// extern BOOL GADAdSizeIsFluid (GADAdSize size);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern bool GADAdSizeIsFluid (GADAdSize size);

	// extern NSString * _Nonnull NSStringFromGADAdSize (GADAdSize size);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern NSString NSStringFromGADAdSize (GADAdSize size);

	// extern NSValue * _Nonnull NSValueFromGADAdSize (GADAdSize size);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern NSValue NSValueFromGADAdSize (GADAdSize size);

	// extern GADAdSize GADAdSizeFromNSValue (NSValue * _Nonnull value);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADAdSizeFromNSValue (NSValue value);

	// extern NSString * _Nonnull GADGetStringFromVersionNumber (GADVersionNumber version);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern NSString GADGetStringFromVersionNumber (GADVersionNumber version);

	// extern GADAdSize GADClosestValidSizeForAdSizes (GADAdSize original, NSArray<NSValue *> * _Nonnull possibleAdSizes);
	[DllImport ("__Internal")]
	[Verify (PlatformInvoke)]
	static extern GADAdSize GADClosestValidSizeForAdSizes (GADAdSize original, NSValue[] possibleAdSizes);
}

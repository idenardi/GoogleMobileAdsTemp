...
interface UMPConsentForm
{
	...
	// +(void)loadAndPresentIfRequiredFromViewController:(UIViewController * _Nullable)viewController completionHandler:(UMPConsentFormPresentCompletionHandler _Nullable)completionHandler;
	[Static]
	...
	// +(void)presentPrivacyOptionsFormFromViewController:(UIViewController * _Nullable)viewController completionHandler:(UMPConsentFormPresentCompletionHandler _Nullable)completionHandler;
	[Static]
	...
	// -(void)presentFromViewController:(UIViewController * _Nullable)viewController completionHandler:(UMPConsentFormPresentCompletionHandler _Nullable)completionHandler;
